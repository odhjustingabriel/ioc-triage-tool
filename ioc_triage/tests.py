...
class UploadWorkflowTests(TestCase):
    ...
    def test_results_table_displays_distinct_labels_for_legacy_low_confidence_ip_records(self):
        ...
        self.assertContains(response, "Private/internal network")
        self.assertEqual(response.content.decode().count("Internal/private address"), 0)
